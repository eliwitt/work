 ...
 */
 if(isset($_POST['sent']) && $_POST['sent'] == "yes")	    #5
 {
  ...
  if($n_row < 1) // if login unsuccessful	               #39
  {
   ...
   else //if login successful	                           #47
   {
      $row = mysqli_fetch_assoc($result);
      setcookie("first_name",$row['first_name']);	       #50
      setcookie("auth","yes");	#51
      header("Location: secret_page_cookie.php");	#52
   }
 } // end if submitted	                                  #54
